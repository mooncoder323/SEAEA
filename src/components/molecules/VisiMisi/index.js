...
const VisiMisi = () => {
  ...
  return (
    <div className="py-16 parent bg-neutral">
      ...
      >
        <h3 className="text-center text-accent">Goals and Directions</h3>
      ...
      >
        {visiMisi?.map((visiMisi) => (
          ...
          >
            <div className="w-40 mx-auto mb-4 text-center">{visiMisi.icon}</div>
            <h2 className="mb-4 text-2xl font-semibold text-center">
              {visiMisi.title}
            </h2>
            <p className="text-accent">{visiMisi.description}</p>
          </div>
        ))}
      </motion.div>
    </div>
