...
const Service = () => {
  ...
  return (
    <div className="py-20 parent bg-neutral">
      ...
      >
        <h3 className="text-center text-accent">Focus & Service</h3>
        <h1 className="text-4xl font-semibold text-center">
          Solution <span className="text-primary">Digital & Creative</span>
        </h1>
        <BottomLine />
        <h2 className="py-5 text-center text-accent">
          We focus on providing holistic solutions for your business to build
          your brand effectively and consistently through various digital
          channels. We will assist you in developing your business so that your
          company goals can be achieved more effectively.
        </h2>
      </motion.div>
            ...
            <p className="text-accent">
              {service.description.split("\n").map((s, i) => (
                <React.Fragment key={i + 1}>
                  <span className="inline-block mb-4 text-justify text-gray-600 align-bottom">
                    {s}
                  </span>
                  <br />
                </React.Fragment>
