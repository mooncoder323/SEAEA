    ...
    <div className="py-16 parent">
      ...
      >
        ...
        <h2 className="py-5 text-center text-accent">
          Don't hesitate to contact us anytime. You can consult for free with
          our great team that is ready to assist you in creating a website and
          developing your company's business.
        </h2>
      </motion.div>
      <div className="grid grid-cols-1 gap-20 mt-8 md:grid-cols-2">
        ...
        >
          <div className="flex items-center my-6">
            ...
            <h3 className="font-medium text-primary">+381638041039</h3>
          </div>
          <div className="flex items-center my-6">
            <MdEmail className="mr-8 text-3xl duration-300 cursor-pointer hover:text-primary"></MdEmail>
            <h3 className="font-medium text-primary">javsfdev323@gmail.com</h3>
          </div>
          <div className="flex items-center my-6">
            <FaTelegram className="mr-8 text-2xl duration-300 cursor-pointer hover:text-primary"></FaTelegram>
            <h3 className="font-medium text-primary">https://t.me/JavSFDev</h3>
          </div>
          <div className="flex items-center my-6">
            <FaDiscord className="mr-8 text-2xl duration-300 cursor-pointer hover:text-primary"></FaDiscord>
            <h3 className="font-medium text-primary">JavSFDev#9620</h3>
          </div>
          <div className="flex items-center my-6">
            <FaSkype className="mr-8 text-2xl duration-300 cursor-pointer hover:text-primary"></FaSkype>
