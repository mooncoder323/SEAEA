      ...
      <div className="py-16 parent ">
        ...
        >
          <div className="mb-6">
            <h3 className="text-center text-accent">
              Book promotional slots immediately before they run out!
            </h3>
            <h1 className="text-4xl font-semibold text-center">
              Promotional Package Prices{" "}
              <span className="text-primary">In May</span>
            </h1>
            <BottomLine />
            <Countdown />
          </div>
        ...
        >
          <div className="flex flex-wrap items-center justify-center mt-2 mb-6">
            ...
            <button
              className={`btn btn-sm bg-primary border-2 border-primary text-white hover:bg-transparent hover:border-primary hover:text-primary duration-300 mx-3 my-3 sm:my-0 ${
                activeBtn === "tokoonline" && "active-btn"
              }`}
              onClick={() => {
            ...
            <button
              className={`btn btn-sm bg-primary border-2 border-primary text-white hover:bg-transparent hover:border-primary hover:text-primary duration-300 mx-3 my-3 sm:my-0 ${
                activeBtn === "companyprofile" && "active-btn"
              }`}
              onClick={() => {
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 ">
            {items.map((item) => (
              ...
              >
                ...
                <span className="justify-center text-center paket-featured">
                  Discount 34%
                </span>
                ...
                <div className="text-accent">
                  ...
                  <span
                    className="py-4 text-base font-medium text-center cursor-pointer text-accent hover:text-primary"
